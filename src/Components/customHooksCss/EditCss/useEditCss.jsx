...
const useEditModalStyles = (estiloAnimacion) => {
    ...
    return {
        inputsEstilos: `border-none	 w-full p-2 border border-gray-300 rounded-lg  text-stone-100 ${theme === 'dark' ? 'bg-slate-200 text-stone-300 border-gray-500' : 'bg-gray-100 border-gray-500 text-stone-100'}`,
